...
- `output/desktop/FutolStructure-Setup-3.16.125-rc.8-x64.exe` is the release-candidate NSIS installer.
- `output/desktop/FutolStructure-Portable-3.16.125-rc.8-x64.exe` is the matching portable build when the portable target is built.
